        ...
        <div className="grid xl:grid-cols-2 gap-10 md:px-8 px-4 py-20 xl:py-52">
          <div className="flex flex-col justify-between">
            <h2 className="font-sourcecode font-light text-xl text-gunmetal md:text-4xl xl:pr-32">
              ...
              Yorkshire, United Kingdom. We help you develop ideal solutions to
              optimise your business and customer needs, creating digital-first
              web platforms that align brand and product.
            </h2>
